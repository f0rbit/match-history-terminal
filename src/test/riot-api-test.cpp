...
#include "../classes/Curl/UrlReader.h"
...
int main() {
    ...
    cout << read(REQUEST_URL) << endl
         << endl;

    cout << urlReader.read("https://oc1.api.riotgames.com/lol/summoner/v4/summoners/by-name/" + SUMMONER_NAME, false) << endl;
}